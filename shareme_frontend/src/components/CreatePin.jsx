...
const CreatePin = ({user}) => {
  ...
  const uploadImage =(e)=>{
    ...
    if (type  === 'image/png' || type  === 'image/svg' || type  === 'image/jpeg' || type  === 'image/gif' || type  === 'image/svg' || type  === 'image/tiff'){
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      {fields && (
        <p className='txt-red-500 mb-5 text-xl transition-all duration-150 ease-in'>Please fill in all the fields</p>
      )}
              ...
              <label className='cursor-pointer'>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    Please use high-quality JPG, SVG, PNG, GIF, or TIFF less than 20MB.
                  </p>
                </div>
                <input 
                  type="file"
